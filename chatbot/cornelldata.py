...
class CornellData:
    ...
    def __init__(self, dirName):
        ...
        self.lines = self.loadLines(dirName + "sample1_deepqa_3M_lines.txt", MOVIE_LINES_FIELDS)
        self.conversations = self.loadConversations(dirName + "sample1_deepqa_3M_conversation.txt", MOVIE_CONVERSATIONS_FIELDS)
